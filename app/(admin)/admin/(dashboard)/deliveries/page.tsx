...
export default function DeliveriesPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-black text-white">Deliveries</h1>
        <p className="text-sm text-gray-500 mt-0.5">Track shipments across Rwanda & DRC</p>
      </div>
      <motion.div
      ...
      >
        ...
        <h3 className="text-lg font-bold text-white mb-2">Deliveries Module</h3>
        <p className="text-sm text-gray-500 text-center max-w-xs">
          Delivery tracking across Rwanda and Eastern DRC provinces is coming soon.
        </p>
