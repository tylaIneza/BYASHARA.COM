...
export default function FlashSalesPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-black text-white">Flash Sales</h1>
        <p className="text-sm text-gray-500 mt-0.5">Manage limited-time deals and promotions</p>
      </div>
      <motion.div
      ...
      >
        ...
        <h3 className="text-lg font-bold text-white mb-2">Flash Sales Module</h3>
        <p className="text-sm text-gray-500 text-center max-w-xs">
          Create and manage time-limited flash deals with countdown timers. Coming soon.
        </p>
