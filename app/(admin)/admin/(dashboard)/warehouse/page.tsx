...
export default function WarehousePage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-black text-white">Warehouse</h1>
        <p className="text-sm text-gray-500 mt-0.5">Inventory and stock management</p>
      </div>
      <motion.div
      ...
      >
        <div className="h-16 w-16 rounded-2xl bg-[#FF6B00]/10 flex items-center justify-center mb-4">
          <Warehouse className="h-8 w-8 text-[#FF6B00]" />
        </div>
        <h3 className="text-lg font-bold text-white mb-2">Warehouse Module</h3>
        <p className="text-sm text-gray-500 text-center max-w-xs">
          Stock management and inventory tracking is coming soon.
        </p>
